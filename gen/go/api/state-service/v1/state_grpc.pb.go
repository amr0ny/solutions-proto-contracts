...
const (
	StateService_GetState_FullMethodName = "/api.state_service.v1.StateService/GetState"
	StateService_SetState_FullMethodName = "/api.state_service.v1.StateService/SetState"
)
...
func (c *stateServiceClient) SetState(ctx context.Context, in *SetStateRequest, opts ...grpc.CallOption) (*SetStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedStateServiceServer) SetState(context.Context, *SetStateRequest) (*SetStateResponse, error) {
...
func _StateService_SetState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StateServiceServer).SetState(ctx, req.(*SetStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.state_service.v1.StateService",
	...
	Metadata: "api/state-service/v1/state.proto",
}
